  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-bg px-4">
      <div className="max-w-md text-center">
        <div className="font-mono text-[10px] uppercase tracking-[0.25em] text-accent">Error · 404</div>
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-bg px-4">
      <div className="max-w-md text-center">
        <div className="font-mono text-[10px] uppercase tracking-[0.25em] text-danger">System error</div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Investigate Solana wallets, detect exploit patterns, and store immutable on-chain evidence with an AI forensic copilot." },
      { name: "author", content: "ForensiqAI" },
      { property: "og:title", content: "ForensiqAI — Blockchain Forensic Investigator" },
      { property: "og:description", content: "AI-powered blockchain forensic investigation, on-chain evidence, voice-narrated reports." },
